  ...
  namespace frontend
  {
    namespace test
    {
      class ParserTests : public CppUnit::TestFixture
      {
        ...
        CPPUNIT_TEST(test_parser_parses_type_synonym_function_instance_definition);
        CPPUNIT_TEST(test_parser_parses_datatype_function_instance_definition);
        CPPUNIT_TEST(test_parser_parses_unique_datatype_function_instance_definition);
        CPPUNIT_TEST(test_parser_parses_datatype_function_instance_definition_without_constructors);
        CPPUNIT_TEST(test_parser_parses_unique_datatype_function_instance_definition_without_constructors);
        CPPUNIT_TEST(test_parser_parses_type_synonym_function_instance_template_definition);
        CPPUNIT_TEST(test_parser_parses_datatype_function_instance_template_definition);
        CPPUNIT_TEST(test_parser_parses_unique_datatype_function_instance_template_definition);
        CPPUNIT_TEST(test_parser_parses_datatype_function_instance_template_definition_without_constructors);
        CPPUNIT_TEST(test_parser_parses_unique_datatype_function_instance_template_definition_without_constructors);
      ...
      public:
        ...
        void test_parser_parses_type_synonym_function_instance_definition();
        void test_parser_parses_datatype_function_instance_definition();
        void test_parser_parses_unique_datatype_function_instance_definition();
        void test_parser_parses_datatype_function_instance_definition_without_constructors();
        void test_parser_parses_unique_datatype_function_instance_definition_without_constructors();
        void test_parser_parses_type_synonym_function_instance_template_definition();
        void test_parser_parses_datatype_function_instance_template_definition();
        void test_parser_parses_unique_datatype_function_instance_template_definition();
        void test_parser_parses_datatype_function_instance_template_definition_without_constructors();
        void test_parser_parses_unique_datatype_function_instance_template_definition_without_constructors();
