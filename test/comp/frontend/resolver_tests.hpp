  ...
  namespace frontend
  {
    namespace test
    {
      class ResolverTests : public CppUnit::TestFixture
      {
        ...
        CPPUNIT_TEST(test_resolver_gives_constructor_from_named_field_constructor_application_for_alias_variable);
        CPPUNIT_TEST(test_resolver_gives_constructor_from_variable_constructor_pattern_for_alias_variable);
        CPPUNIT_TEST(test_resolver_gives_constructor_from_function_constructor_pattern_for_alias_variable);
        CPPUNIT_TEST(test_resolver_gives_constructor_from_named_field_constructor_pattern_for_alias_variable);
        ...
        CPPUNIT_TEST(test_resolver_complains_on_errors);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_variable_for_variable);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_variable_for_function);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_variable_for_constructor_at_datatype);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_variable_for_constructor_at_datatype_instance);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_variable_for_constructor_at_unique_datatype);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_variable_for_constructor_at_unique_datatype_instance);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_type);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_type_template);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_module_for_absolute_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_module_for_relative_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_variable_for_absolute_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_variable_for_relative_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_variable_for_relative_identifier_and_imported_module);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_variable_for_relative_identifier_and_imported_module_with_private_variable);
        CPPUNIT_TEST(test_resolver_complains_on_private_variable_for_absolute_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_private_variable_for_relative_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_for_absolute_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_for_relative_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_for_relative_identifier_and_imported_module);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_for_relative_identifier_and_imported_module_with_private_type);
        CPPUNIT_TEST(test_resolver_complains_on_private_type_for_absolute_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_private_type_for_relative_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_template_for_absolute_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_template_for_relative_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_template_for_relative_identifier_and_imported_module);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_template_for_relative_identifier_and_imported_module_with_private_type_template);
        CPPUNIT_TEST(test_resolver_complains_on_private_type_template_for_absolute_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_private_type_template_for_relative_identifier);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_argument_for_function);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_variable_for_let_expression);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_variable_for_let_expression_and_tuple_binding);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_variable_for_match_expression);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_argument_for_lambda_value);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_variable_for_primitive_lambda_value);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_type_argument);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_parameter);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_parameter_for_instance_type_parameter);
        CPPUNIT_TEST(test_resolver_complains_on_type_parameter_in_type);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_parameter_for_variable_template);
        CPPUNIT_TEST(test_resolver_complains_on_type_parameters_in_variable);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_type_parameter_for_function_template);
        CPPUNIT_TEST(test_resolver_complains_on_type_parameters_in_function);
        CPPUNIT_TEST(test_resolver_complains_on_unsupported_annotation);
        CPPUNIT_TEST(test_resolver_complains_on_eager_annotation_and_lazy_annotation);
        CPPUNIT_TEST(test_resolver_complains_on_memoized_annotation_and_unmemoized_annotation);
        CPPUNIT_TEST(test_resolver_complains_on_non_constructor_variable_for_named_field_constructor_application);
        CPPUNIT_TEST(test_resolver_complains_on_incorrect_constructor_for_named_field_constructor_application);
        CPPUNIT_TEST(test_resolver_complains_on_too_few_fields_for_named_field_constructor_application);
        CPPUNIT_TEST(test_resolver_complains_on_too_many_fields_for_named_field_constructor_application);
        CPPUNIT_TEST(test_resolver_complains_on_already_specified_field_for_named_field_constructor_application);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_field_for_named_field_constructor_application);
        CPPUNIT_TEST(test_resolver_complains_on_non_constructor_variable_for_variable_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_incorrect_constructor_for_variable_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_non_constructor_variable_for_function_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_incorrect_constructor_for_function_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_too_few_fields_for_function_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_too_many_fields_for_function_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_non_constructor_variable_for_named_field_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_incorrect_constructor_for_named_field_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_too_few_fields_for_named_field_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_too_many_fields_for_named_field_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_already_specified_field_for_named_field_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_field_for_named_field_constructor_pattern);
        CPPUNIT_TEST(test_resolver_complains_on_non_constructor_variable_for_variable_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_incorrect_constructor_for_variable_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_non_constructor_variable_for_function_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_incorrect_constructor_for_function_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_too_few_fields_for_function_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_too_many_fields_for_function_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_non_constructor_variable_for_named_field_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_incorrect_constructor_for_named_field_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_too_few_fields_for_named_field_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_too_many_fields_for_named_field_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_already_specified_field_for_named_field_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_undefined_field_for_named_field_constructor_value);
        CPPUNIT_TEST(test_resolver_complains_on_already_defined_field_at_constructor);
        CPPUNIT_TEST(test_resolver_complains_on_alias_variable_reference_to_undefined_variable);
        CPPUNIT_TEST(test_resolver_complains_on_alias_variable_reference_to_alias_cycle);
      ...
      public:
        ...
        void test_resolver_gives_constructor_from_named_field_constructor_application_for_alias_variable();
        void test_resolver_gives_constructor_from_variable_constructor_pattern_for_alias_variable();
        void test_resolver_gives_constructor_from_function_constructor_pattern_for_alias_variable();
        void test_resolver_gives_constructor_from_named_field_constructor_pattern_for_alias_variable();
        ...
        void test_resolver_complains_on_errors();
        void test_resolver_complains_on_already_defined_variable_for_variable();
        void test_resolver_complains_on_already_defined_variable_for_function();
        void test_resolver_complains_on_already_defined_variable_for_constructor_at_datatype();
        void test_resolver_complains_on_already_defined_variable_for_constructor_at_datatype_instance();
        void test_resolver_complains_on_already_defined_variable_for_constructor_at_unique_datatype();
        void test_resolver_complains_on_already_defined_variable_for_constructor_at_unique_datatype_instance();
        void test_resolver_complains_on_already_defined_type();
        void test_resolver_complains_on_already_defined_type_template();
        void test_resolver_complains_on_undefined_module_for_absolute_identifier();
        void test_resolver_complains_on_undefined_module_for_relative_identifier();
        void test_resolver_complains_on_undefined_variable_for_absolute_identifier();
        void test_resolver_complains_on_undefined_variable_for_relative_identifier();
        void test_resolver_complains_on_undefined_variable_for_relative_identifier_and_imported_module();
        void test_resolver_complains_on_undefined_variable_for_relative_identifier_and_imported_module_with_private_variable();
        void test_resolver_complains_on_private_variable_for_absolute_identifier();
        void test_resolver_complains_on_private_variable_for_relative_identifier();
        void test_resolver_complains_on_undefined_type_for_absolute_identifier();
        void test_resolver_complains_on_undefined_type_for_relative_identifier();
        void test_resolver_complains_on_undefined_type_for_relative_identifier_and_imported_module();
        void test_resolver_complains_on_undefined_type_for_relative_identifier_and_imported_module_with_private_type();
        void test_resolver_complains_on_private_type_for_absolute_identifier();
        void test_resolver_complains_on_private_type_for_relative_identifier();
        void test_resolver_complains_on_undefined_type_template_for_absolute_identifier();
        void test_resolver_complains_on_undefined_type_template_for_relative_identifier();
        void test_resolver_complains_on_undefined_type_template_for_relative_identifier_and_imported_module();
        void test_resolver_complains_on_undefined_type_template_for_relative_identifier_and_imported_module_with_private_type_template();
        void test_resolver_complains_on_private_type_template_for_absolute_identifier();
        void test_resolver_complains_on_private_type_template_for_relative_identifier();
        void test_resolver_complains_on_already_defined_argument_for_function();
        void test_resolver_complains_on_already_defined_variable_for_let_expression();
        void test_resolver_complains_on_already_defined_variable_for_let_expression_and_tuple_binding();
        void test_resolver_complains_on_already_defined_variable_for_match_expression();
        void test_resolver_complains_on_already_defined_argument_for_lambda_value();
        void test_resolver_complains_on_undefined_variable_for_primitive_lambda_value();
        void test_resolver_complains_on_already_defined_type_argument();
        void test_resolver_complains_on_undefined_type_parameter();
        void test_resolver_complains_on_undefined_type_parameter_for_instance_type_parameter();
        void test_resolver_complains_on_type_parameter_in_type();
        void test_resolver_complains_on_undefined_type_parameter_for_variable_template();
        void test_resolver_complains_on_type_parameters_in_variable();
        void test_resolver_complains_on_undefined_type_parameter_for_function_template();
        void test_resolver_complains_on_type_parameters_in_function();
        void test_resolver_complains_on_unsupported_annotation();
        void test_resolver_complains_on_eager_annotation_and_lazy_annotation();
        void test_resolver_complains_on_memoized_annotation_and_unmemoized_annotation();
        void test_resolver_complains_on_non_constructor_variable_for_named_field_constructor_application();
        void test_resolver_complains_on_incorrect_constructor_for_named_field_constructor_application();
        void test_resolver_complains_on_too_few_fields_for_named_field_constructor_application();
        void test_resolver_complains_on_too_many_fields_for_named_field_constructor_application();
        void test_resolver_complains_on_already_specified_field_for_named_field_constructor_application();
        void test_resolver_complains_on_undefined_field_for_named_field_constructor_application();
        void test_resolver_complains_on_non_constructor_variable_for_variable_constructor_pattern();
        void test_resolver_complains_on_incorrect_constructor_for_variable_constructor_pattern();
        void test_resolver_complains_on_non_constructor_variable_for_function_constructor_pattern();
        void test_resolver_complains_on_incorrect_constructor_for_function_constructor_pattern();
        void test_resolver_complains_on_too_few_fields_for_function_constructor_pattern();
        void test_resolver_complains_on_too_many_fields_for_function_constructor_pattern();
        void test_resolver_complains_on_non_constructor_variable_for_named_field_constructor_pattern();
        void test_resolver_complains_on_incorrect_constructor_for_named_field_constructor_pattern();
        void test_resolver_complains_on_too_few_fields_for_named_field_constructor_pattern();
        void test_resolver_complains_on_too_many_fields_for_named_field_constructor_pattern();
        void test_resolver_complains_on_already_specified_field_for_named_field_constructor_pattern();
        void test_resolver_complains_on_undefined_field_for_named_field_constructor_pattern();
        void test_resolver_complains_on_non_constructor_variable_for_variable_constructor_value();
        void test_resolver_complains_on_incorrect_constructor_for_variable_constructor_value();
        void test_resolver_complains_on_non_constructor_variable_for_function_constructor_value();
        void test_resolver_complains_on_incorrect_constructor_for_function_constructor_value();
        void test_resolver_complains_on_too_few_fields_for_function_constructor_value();
        void test_resolver_complains_on_too_many_fields_for_function_constructor_value();
        void test_resolver_complains_on_non_constructor_variable_for_named_field_constructor_value();
        void test_resolver_complains_on_incorrect_constructor_for_named_field_constructor_value();
        void test_resolver_complains_on_too_few_fields_for_named_field_constructor_value();
        void test_resolver_complains_on_too_many_fields_for_named_field_constructor_value();
        void test_resolver_complains_on_already_specified_field_for_named_field_constructor_value();
        void test_resolver_complains_on_undefined_field_for_named_field_constructor_value();
        void test_resolver_complains_on_already_defined_field_at_constructor();
        void test_resolver_complains_on_alias_variable_reference_to_undefined_variable();
        void test_resolver_complains_on_alias_variable_reference_to_alias_cycle();
      };
    }
  }
}
